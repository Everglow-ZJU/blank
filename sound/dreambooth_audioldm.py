...
def log_validation(text_encoder, tokenizer, unet, vae, args, accelerator, weight_dtype, global_step,vocoder,concept_audio_dir, validate_experiments=False):
    ...
    for tracker in accelerator.trackers:
        if tracker.name == "tensorboard":
            ...
            for i, audio in enumerate(audios):
                ...
                #TODO:if we can get the audios from the tensorboard
    ...
    if validate_experiments:#TODO:maybe means validate whether the class prior is kept?
...
def parse_args():
    ...
    parser.add_argument(
        "--num_vectors", #TODO:useful in multi-concept training
        type=int,
        default=1,
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                if accelerator.sync_gradients:
                    params_to_clip = (
                        itertools.chain(unet.parameters(), text_encoder.parameters()) #TODO:this is important
                        if args.train_text_encoder
