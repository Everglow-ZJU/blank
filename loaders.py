...
from .oft_utils.attention_processor import (
    OFTAttnProcessor
)
    ...
    def load_attn_procs(self, pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]], **kwargs):
        ...
        if is_lora:
            ...
            for key, value_dict in oft_grouped_dict.items():
                ...
                for sub_key in key.split("."):
                    attn_processor=getattr(attn_processor,sub_key)
            attn_processor_class=OFTAttnProcessor
            cross_attention_dim=value_dict["to_k_oft.cross_attention_dim"]
            hidden_size=value_dict["to_k_oft.hidden_size"]
