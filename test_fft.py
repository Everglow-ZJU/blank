...
def fft_matrix_gpu(input_matrix):
    ...
    """
    # Ensure the input_matrix is in complex format (dtype=torch.complex64) on GPU.
    input_matrix = input_matrix.to(torch.complex64).cuda()
    ...
    return fft_result, ifft_result_real
